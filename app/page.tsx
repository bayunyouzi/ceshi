...
import { img2ImgPrompts as defaultImg2ImgPrompts, img2ImgEffectOptions as defaultImg2ImgEffectOptions } from "../lib/img2imgPrompts";
...
export default function Home() {
  ...
  const [dynamicImg2ImgPrompts, setDynamicImg2ImgPrompts] = useState<Record<string, string> | null>(null);
  const img2ImgPrompts = dynamicImg2ImgPrompts || defaultImg2ImgPrompts;
  const img2ImgEffectOptions = defaultImg2ImgEffectOptions;
  ...
  useEffect(() => {
    ...
    fetch("/api/config")
      ...
      .then(data => {
        if (data?.img2imgPrompts && typeof data.img2imgPrompts === 'object') {
          setDynamicImg2ImgPrompts(data.img2imgPrompts);
        }
      })
      .catch(() => {}); // 静默失败，使用默认值
